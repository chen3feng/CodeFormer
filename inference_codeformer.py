...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--device', type=str, default=None,
                        help='Computing device, can be cpu|cuda|mps|dml')
    ...
    input_video = False
    if args.input_path.lower().endswith(('jpg', 'jpeg', 'png', 'webp')):  # input single img path
        input_img_list = [args.input_path]
        result_root = f'results/test_img_{w}'
    elif args.input_path.lower().endswith(('mp4', 'mov', 'avi')):  # input video path
